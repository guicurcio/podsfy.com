 ...
 * PodGuests Component
 */
export default function PodGuests({ className, title }: PodGuestsProps) {
  return (
    <div className={twMerge('grid grid-flow-row gap-2 py-2', className)}>
      <div className="grid grid-flow-col justify-start gap-3 items-center px-4">
        ...
        <h2 className="text-[13.5px] self-center align-middle font-medium font-moderat text-left text-[#a5a5a5]/80 antialiased tracking-[-0.03em]">
          Guest Appearances {title && `in`} {title}
        </h2>
      </div>
      <div className="grid grid-flow-col items-start justify-start  gap-[32px] py-[12px]">
        <Link href="/podcast/call-her-daddy">
          <img
            src="/ab67706c0000bebbe74171c42b0069e80316ab7e.jpeg"
            className=" h-[80px] w-[80px] rounded-full object-cover border border-black cursor-pointer hover:scale-105 transition-all duration-500 ease-in-out"
          />
        </Link>
        <img
          src="/images-(10).jpeg"
