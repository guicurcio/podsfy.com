          ...
          <div className="mx-auto grid w-[1200px]  max-w-[1200px] grid-flow-col   items-center justify-center">
            <NavigationMenu className="">
              <NavigationMenuList className="mx-auto grid grid-flow-col items-center gap-[8px] ">
                ...
                <NavigationMenuItem
                  className={mergeClasses(
                    pathName.split("/")[3] === "relationships" &&
                      " border-b-[2px] border-white/20"
                  )}
                >
                  <Link
                    href="/podcast/category/relationships"
                    legacyBehavior
                    passHref
                  >
                    <NavigationMenuLink
                ...
                <NavigationMenuItem
                  className={mergeClasses(
                    pathName.split("/")[3] === "conversations" &&
                ...
                <NavigationMenuItem
                  className={mergeClasses(
                    pathName.split("/")[3] === "entrepreneurship" &&
                      "border-b-2 border-white/20"
                  )}
                >
