 ...
 */
export default function PodSimilar({ className }: PodSimilarProps) {
  return (
    <div className={twMerge("grid grid-flow-row gap-2 py-2", className)}>
      <div className="grid grid-flow-col justify-start gap-3 items-center px-4">
        ...
        <h2 className="text-[13.5px] self-center align-middle font-medium font-moderat text-left text-[#a5a5a5]/80 antialiased tracking-[-0.03em]">
          Similar Podcasts to The Huberman Lab Podcast
        </h2>
      </div>
      <div className="grid grid-flow-col mx-auto relative gap-[32px] py-[12px]">
        <Link href="/podcast/call-her-daddy">
          <img
            ...
            className="flex-grow-0 flex-shrink-0 w-[100px] h-[150px] rounded-[15px] object-cover border border-black cursor-pointer hover:scale-105 transition-all duration-500 ease-in-out"
