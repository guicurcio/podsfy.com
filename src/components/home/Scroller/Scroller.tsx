              ...
              <TooltipProvider delayDuration={100}>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      onClick={() => {
                        // toast.custom((t) => (
                        //   <div
                        //     className="overflow-x-hidden rounded-[3px] border-0 bg-[#1f1f23]
                        //  px-5 py-3 font-visuelt text-[13px] font-normal text-white/50 shadow-3xl"
                        //   >
                        //     Refreshed
                        //   </div>
                        // ))
                  ...
                  <TooltipPortal>
                    ...
                    >
                      <p>Refresh feed</p>
                      <TooltipArrow className="!stroke-[#1f1f23] !text-[#1f1f23]"></TooltipArrow>
                    </TooltipContent>
                  </TooltipPortal>
                </Tooltip>
                <Tooltip>
